...
Kelicap apps are styled with standard CSS. That means you can apply
everything you know about CSS stylesheets, selectors, rules, and media queries
directly to Kelicap apps.

Additionally, Kelicap can bundle *component styles*
...
For every Kelicap component you write, you may define not only an HTML template,
...
Kelicap supports a few special selectors from the world of shadow DOM style scoping
...
* `Emulated` (the default): Kelicap emulates the behavior of shadow DOM by preprocessing
...
* `None`: Kelicap does no view encapsulation. Instead it makes the component's styles global.
...
When using emulated view encapsulation, Kelicap preprocesses
all component styles so that they approximate the standard shadow CSS scoping rules.

In the DOM of a running Kelicap app with emulated view
...
Thankfully, this is the default interpretation of relative URLs in KelicapDart:
...
[encapsulation]: {{site.pub-api}}/Kelicap/{{site.data.pkg-vers.Kelicap.vers}}/di/Component/encapsulation.html
[ViewEncapsulation]: {{site.pub-api}}/Kelicap/{{site.data.pkg-vers.Kelicap.vers}}/Kelicap/ViewEncapsulation-class.html
