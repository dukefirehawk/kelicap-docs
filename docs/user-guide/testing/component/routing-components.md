...
```
  import 'package:Kelicap_tour_of_heroes/src/hero_list_component.template.dart'
      as ng;
  import 'package:Kelicap_tour_of_heroes/src/hero_service.dart';
  import 'package:Kelicap_tour_of_heroes/src/route_paths.dart';
...
[PlatformLocation]: {{site.pub-api}}/Kelicap_router/{{site.data.pkg-vers.Kelicap.vers}}/Kelicap_router/PlatformLocation-class.html
