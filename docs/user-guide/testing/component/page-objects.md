...
description: Techniques and practices for component testing of KelicapDart apps.
...
The [Kelicap_test][] package recognizes page objects implemented using annotations
...
@@ -3,6 +3,9 @@
 ...
 import 'package:Kelicap_tour_of_heroes/app_component.dart';
...
- Source file:
  ...
  - The file doesn't contain any Kelicap annotations (like `@Component` or
    `@GenerateInjector`) that would trigger the Kelicap builder. This is a
...
[Kelicap_test]: https://pub.dev/packages/Kelicap_test
...
[rootElement]: {{site.pub-api}}/Kelicap_test/latest/Kelicap_test/NgTestFixture/rootElement.html
