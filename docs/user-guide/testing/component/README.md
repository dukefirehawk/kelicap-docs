...
[component testing][] of KelicapDart apps using the following packages:
...
[package:Kelicap_test][]
: A complementary package that provides a means of interacting with Kelicap components created as test fixtures.
...
The [Kelicap_test][] package is suitable for testing either a
...
[package:Kelicap_test]: https://pub.dev/packages/Kelicap_test
