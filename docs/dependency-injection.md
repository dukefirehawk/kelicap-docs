...
Kelicap has its own dependency injection framework, and
you really can't build a Kelicap app without it. This page covers what DI is, why it's useful, and how to use DI in Kelicap.
...
What's the problem? The problem is that the `Car` class is brittle, inflexible, and hard to test.
